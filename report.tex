...
\textbf{Algorithm:} $\mu,\lambda$ Binary Genetic Algorithm with Crossover (for MAX-SAT Optimisation) \\
\textit{\textbf{Python Implementation:} ./src/common/maxsat.py} \\
\textit{\textbf{Full Source Code:} https://github.com/joehainess/EC-CA2} \\
...
% quality (number of satisﬁed clauses) of the solutions obtained. For each parameter setting, run the
...
% signiﬁcant computational resources available, you might ﬁnd it useful to start with the smallest
...
% and discuss your ﬁndings. Clearly indicate which of the instances you tested your code on.
...
\begin{itemize} \parskip0pt \parsep0pt
  ...
  \item \textbf{\texttt{crossover\_prob}}: The probability of applying single-point crossover between 2 offspring
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{plots/exercise5/lambda_mu_ratio/lambda_mu_ratio_5s_100x_normalized-fir06_area_delay_rev66-4_10tree305p.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{plots/exercise5/crossover_prob/crossover_prob_5s_100x_normalized-fir06_area_delay_rev66-4_10tree305p.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{plots/exercise5/mutation_prob/mutation_prob_5s_100x_normalized-fir06_area_delay_rev66-4_10tree305p.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{plots/parameter_sweep/mutation_prob/mutation_prob_20s_40x_normalized-fir06_area_delay.png}
